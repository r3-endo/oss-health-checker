...
The system MUST keep backend feature ownership under `apps/backend/features/*`, MUST place only cross-app reusable code under `apps/common/*`, and MUST enforce that apps do not directly depend on each other's internal source modules.
