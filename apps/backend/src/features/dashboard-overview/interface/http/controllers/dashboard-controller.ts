import type { ListDashboardRepositoriesUseCase } from "@backend/src/features/dashboard-overview/application/use-cases/list-dashboard-repositories-use-case.js";
